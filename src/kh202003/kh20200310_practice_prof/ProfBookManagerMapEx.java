...
//		testMap.put("100001", new ProfBook("100001", 1, "인문서적1", "인문저자1"));
//		testMap.put("200005", new ProfBook("200005", 2, "자연과학1", "자연과학저자1"));
//		testMap.put("400004", new ProfBook("400004", 4, "기타서적1", "기타저자1"));
//		testMap.put("100009", new ProfBook("100009", 1, "인문학정의2", "인문저자2"));
//		testMap.put("300007", new ProfBook("300007", 3, "의료와기기1", "의료저자1"));
//		testMap.put("200003", new ProfBook("200003", 2, "자연과학2", "자연과학저자2"));
//		
//		//테스트용 맵 초기화
